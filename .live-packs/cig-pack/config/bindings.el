...
;; most of the contents of, default-bindings.el with a few key bindings removed
...
;;(define-key dit-mode-map (kbd "C-\\") 'paredit-backward-kill-word)
...
;; Reminders of useful shortcuts which are there by default
;;kill line
;; C-S-Backspace will kill the current line
